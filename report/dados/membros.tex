...
\begin{membro}
\nome{Rodrigo Cézar}
\tarefas{\hline Ajudar pessoas da navegação & 4.0 \\
\hline Brainstorms e Decisões da navegação sobre o Veículo & 1.5 \\
\hline Consertos do Bot & 4.0 \\
\hline Discussões sobre Modelagem do Barco & 1.5 \\
\hline Reunião de coordenadores & 2.0 \\
\hline Reuniões da navegação & 2.0 \\
\hline Reuniões do Veículo Terrestre & 3.5 \\
\hline Reuniões gerais da equipe & 3.0 \\
\hline Tutoriais de gazebo & 3.0 \\}{24.5}
\planos{}
\comentarios{}
\end{membro}
