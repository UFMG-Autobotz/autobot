...
\rhead{\includegraphics{autobotz}}
\cfoot{\includegraphics{macro}}
...
\hline
 \rowcolor[RGB]{230,245,255}\centering \bf Atividades & \bf Horas \\
\tarefa
\hline \multicolumn{1}{r|}{Total:} & \cellcolor[RGB]{255,240,240} \horas \\
\cline{2-2}
\end{tabular}
\end{center}
}~
